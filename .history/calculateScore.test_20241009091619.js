...
describe('calculateScore', () => {    
    ...
    test('should return a score of 4 when "enjoys_job", "good_for_carers", "hourly_rate", and work no more than 8 hours exceeding what they are contracted for meet the conditions', () => {
        const result = calculateScore(employeeDataWithThreeScore);
